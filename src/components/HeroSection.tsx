    ...
    >
      ...
      <motion.div style={{ opacity: textOpacity, y: textY }} className="overflow-hidden mt-6 sm:mt-4 md:-mt-5 relative z-10">
        <FadeIn delay={0.15} y={40}>
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-[9vw] sm:text-[10vw] md:text-[11vw] lg:text-[12vw] text-center">
