...
import atmWelcome from "@/assets/projects/atm-welcome.png";
...
const projects: Project[] = [
  ...
  },
  {
    ...
    href: "https://github.com/iiYARA/atm-banking-system",
    buttonLabel: "View GitHub",
    customBoxes: {
      topLeft: (
        <img src={atmWelcome} alt="ATM user login welcome screen" className="w-full h-full object-contain bg-white" />
      ),
      bottomLeft: (
        <img src={atmAdmin} alt="ATM admin login screen" className="w-full h-full object-contain bg-black" />
      ),
      right: (
        <img src={atmMachine} alt="ATM machine transaction interface" className="w-full h-full object-contain bg-white" />
      ),
    },
  },
];
